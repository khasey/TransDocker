...
interface ChatContextProps {
  ...
  searchedchannel: string | null; // Ajoutez ceci
  setSearchedChannel: Dispatch<SetStateAction<string | null>>; 
}
...
export const ChatContextProvider: React.FC<{ children: ReactNode; user : User|null }> = ({ children, user }) => {
  ...
  const [searchedchannel, setSearchedChannel] = useState<string | null>(null); // Ajoutez ceci
