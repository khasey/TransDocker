...
useEffect(() => {
  ...
  return (
    <ChatContext.Provider value={{ messages, setMessages ,user:null ,refreshKey, setRefreshKey, searchedchannel:null, setSearchedChannel}}>
      <div>
              ...
              <div className={styles.inside_chat}>
                ...
                <div className={styles.channel_tchat}>
                  ...
                  <div className={styles.tchat}>
                    ...
                    {messages.filter(message => Number(message.channelId) === searchedchannel?.id).map((message) => (
                    <TextSend
                      message={message}
                      // user={message.user}
                      // id={message.id}
